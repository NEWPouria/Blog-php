                    ...
                    <?php if (!empty($articles)): ?>
                        <?php foreach ($articles as $article): ?>
                            ...
                            <a href="singlepost.php?articleID=<?= $article['ArticleID'] ?>"
                                ...
                                ?>
                                <div class="profile_pic" style="display: flex; justify-content: flex-start; align-items: center; gap: 10px;">
                                    <img  style="width: 50px; height: 50px;" src="/Blog/css/profile.png" alt=""> <h3>  <?= htmlspecialchars(ucfirst($Autherinfo['UserName'])) ?></h3>
                                </div>
